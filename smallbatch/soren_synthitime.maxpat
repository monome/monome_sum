...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 510.0, 67.0, 19.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 144.0, 540.0, 73.0, 19.0 ],
									"text" : "counter 1 16"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 90.0, 60.0, 32.5, 19.0 ],
													"text" : "t b i"
												}
...
,
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 144.0, 162.0, 94.0, 19.0 ],
													"saved_object_attributes" : 													{
														"embed" : 1
													}
,
...
,
									"patching_rect" : [ 54.0, 444.0, 87.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Andale Mono",
										"default_fontsize" : 12.0,
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 162.0, 174.0, 59.5, 19.0 ],
													"text" : "t b 1 l 1."
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 162.0, 240.0, 25.0, 25.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 144.0, 606.0, 32.5, 19.0 ],
									"text" : "t b i"
								}
