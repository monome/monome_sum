...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 570.0, 791.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 958.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 100.0, 1056.0, 39.0, 19.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 849.5, 591.0, 59.5, 59.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 270.0, 939.0, 39.0, 19.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.5, 745.0, 309.0, 17.0 ],
					"text" : "1.4 52.246113 -0.864407 0. 992.676147 -0.864407"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 66.25, 1103.0, 80.0, 13.0 ]
				}
...
,
					"patching_rect" : [ 118.0, 840.0, 48.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 118.0, 810.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 384.0, 37.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 261.0, 126.0, 37.0, 19.0 ],
					"text" : "noiz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 384.0, 37.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 202.0, 126.0, 37.0, 19.0 ],
					"text" : "rect"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 384.0, 30.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 155.0, 126.0, 30.0, 19.0 ],
					"text" : "si"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 126.0, 30.0, 19.0 ],
					"text" : "tri"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 126.0, 30.0, 19.0 ],
					"text" : "saw"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 126.0, 245.0, 18.0 ],
					"setminmax" : [ 0.0, 4.0 ],
					"slidercolor" : [ 1.0, 0.8, 0.4, 1.0 ],
					"thickness" : 1,
					"varname" : "waveshape"
...
,
					"patching_rect" : [ 54.0, 840.0, 54.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Andale Mono",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 211.0, 715.0, 64.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"cutoffhz" : [ 5919.910645 ],
						"env-length" : [ 1044.922241 ],
						"env-shape" : [ -0.864407 ],
						"env-slope" : [ 0.05 ],
						"env2mod" : [ 0 ],
						"envtofilt" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 54.0, 810.0, 20.0, 20.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 485.0, 73.0, 50.0, 17.0 ],
									"text" : "25 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 485.0, 18.0, 162.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 154.5, 346.0, 44.0, 17.0 ],
									"text" : "$1 127"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 328.0, 54.0, 46.0, 19.0 ],
									"text" : "t i i 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 328.0, 18.0, 142.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 123.0, 49.0, 19.0 ],
									"text" : "pack i 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 106.75, 123.0, 61.0, 19.0 ],
									"text" : "pack i 127"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 126.0, 45.0, 46.0, 19.0 ],
									"text" : "t b i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 170.0, 70.0, 58.0, 19.0 ],
									"text" : "delay 150"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 126.0, 18.0, 183.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 258.0, 899.0, 340.0, 17.0 ],
									"text" : "42 7 0.020408 3.7 2793.825928 0.816327 0.25 32. 1 0 0 100 1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 669.0, 597.0, 62.0, 94.0 ],
									"text" : "25 33 -0.183673 0. 5919.910645 0. 0.0625 0. 0 0 0 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.5, 346.0, 44.0, 17.0 ],
									"text" : "42 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 403.0, 577.0, 32.5, 19.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 185.5, 491.0, 146.0, 32.0 ],
									"text" : "step\n(don't gather curve from UI)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 23.0, 491.0, 38.0, 19.0 ],
									"text" : "notes"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 139.5, 491.0, 46.0, 19.0 ],
									"text" : "t b b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 64.5, 442.0, 41.0, 19.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 104.5, 282.0, 81.0, 19.0 ],
									"text" : "step, trigger in"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 23.0, 54.0, 49.0, 19.0 ],
									"text" : "notes in"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 259.5, 652.0, 37.0, 19.0 ],
									"text" : "zl reg"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 457.0, 612.0, 107.0, 19.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 104.5, 325.0, 38.0, 19.0 ],
									"text" : "t 47 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.5, 301.0, 144.0, 20.0 ],
									"text" : "r [batch]step_noteTrigger"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 406.0, 536.0, 158.0, 19.0 ],
									"text" : "output preset sounds for Step"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 403.0, 556.0, 111.0, 19.0 ],
									"text" : "r [batch]stepVoiceNr"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 661.0, 427.0, 238.0, 19.0 ],
									"restore" : [ 1.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 358.0, 612.0, 94.0, 19.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1042.0, 690.0, 201.0, 17.0 ],
									"text" : "transpose, finetune, waveshape, cutoff"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 994.0, 163.5, 150.0, 160.0 ],
									"text" : "flin (high)\npolygome (mid)\n\ncorners (low)\n\ntiltrap (preset sounds)\nkradle (preset sounds)\n\nno sounds:\nmlr\n*mesh\naudio in"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.0, 749.0, 83.0, 19.0 ],
									"text" : "prepend target"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 64.5, 491.0, 32.5, 19.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 205.0, 652.0, 37.0, 19.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 23.0, 128.0, 32.5, 19.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 114.0, 391.0, 62.0, 19.0 ],
									"text" : "poly 16 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 64.5, 210.0, 32.5, 19.0 ],
									"text" : "!= 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 250.0, 32.5, 19.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 36.5, 162.0, 47.0, 19.0 ],
									"text" : "unpack"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 406.0, 697.0, 150.0, 19.0 ],
									"text" : "gather curve"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 370.0, 697.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "bang" ],
									"patching_rect" : [ 205.0, 682.0, 46.0, 19.0 ],
									"text" : "t l b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 349.0, 778.0, 37.0, 19.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 349.0, 808.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 406.0, 733.0, 87.0, 19.0 ],
									"text" : "curve factors"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 370.0, 733.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 205.0, 808.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 73.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 648.0, 402.0, 224.0, 19.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 630.0, 378.0, 217.0, 19.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 612.0, 354.0, 229.0, 19.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 594.0, 330.0, 221.0, 19.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 576.0, 306.0, 217.0, 19.0 ],
									"restore" : [ 0.0625 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 558.0, 282.0, 228.0, 19.0 ],
									"restore" : [ 0.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 540.0, 258.0, 217.0, 19.0 ],
									"restore" : [ 5919.910645 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 522.0, 234.0, 233.0, 19.0 ],
									"restore" : [ 0.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 504.0, 210.0, 217.0, 19.0 ],
									"restore" : [ -0.183673 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 486.0, 186.0, 227.0, 19.0 ],
									"restore" : [ 33 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 472.5, 458.0, 181.0, 19.0 ],
									"text" : "pack i 0 0. f 0. 0. 0. 0. 0 0 0 f f"
								}
...
,
					"patching_rect" : [ 270.0, 890.0, 162.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 126.0, 101.0, 50.0, 19.0 ],
					"varname" : "transpose"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 974.0, 54.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 270.0, 915.0, 209.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 104.0, 111.0, 22.0 ],
					"text" : "timbre"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 52.246113, 1.4, 0, -0.864407, 1044.922241, 0.0, 0, -0.864407 ],
					"bgcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
