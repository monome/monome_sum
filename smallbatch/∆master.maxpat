...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 169.0, 100.0, 121.0, 20.0 ],
...
,
					"patching_rect" : [ 868.5, 544.0, 61.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 936.0, 524.5, 137.0, 20.0 ],
...
,
					"patching_rect" : [ 936.0, 554.5, 75.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Andale Mono",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.0, 480.0, 97.0, 20.0 ],
					"text" : "loadmess 127"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 360.0, 18.0, 18.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 186.0, 18.0, 18.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 594.0, 48.0, 18.0, 18.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 630.0, 330.0, 54.0, 102.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 354.0, 26.0, 26.0 ],
					"varname" : "_polygome64"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 186.0, 228.0, 170.0 ],
					"varname" : "flin"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 258.0, 73.0, 189.5, 216.5 ],
					"varname" : "_mlr"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 380.5, 26.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 168.0, 382.0, 50.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 380.5, 90.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 354.0, 79.0, 22.0 ],
					"text" : "polygome"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 354.0, 228.0, 66.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1116.0, 498.0, 167.0, 33.0 ],
					"presentation" : 1,
